...
Pressure is higher upstream and lower downstream, and so the **gradient points upstream**. Once flow is occurring it is resisted by friction at the walls — the shear force at the walls points **upstream**. At steady-state, these forces balance each other.
:::
