...
We have some intuition, and maybe some experience, with the variables of fluid mechanics: pressure pushes on things, something that is highly viscous is harder to move through, denser objects weigh more. But, as I said in class on Day 0, this is arguably your first "applied math" course... if we are going to be putting those ideas into equations, we need to be precise about what they mean.
...
2. Pressure is not a force, it is a scalar field. Think about the ideal gas law: $pV=NRT$... there is no direction to that pressure, only a magnitude. We can describe the value of pressure at every location within a fluid.


## Gauge vs. absolute pressure

When we think about inflating a car tire, the pressure is measured in psi (pounds per square inch, a force per area... a pressure). In my car the pressure is usually reported as 34 psi, but there is a subtlety: that is **the gauge pressure**.
...
When it comes to mechanical forces, the gauge pressure is more convenient. Compare these calculations:
